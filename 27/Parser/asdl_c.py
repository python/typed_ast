...
class ASTModuleVisitor(PickleVisitor):
    ...
    def visitModule(self, mod):
        ...
        self.emit("static struct PyModuleDef _typed_ast_27_module = {", 0)
        self.emit('  PyModuleDef_HEAD_INIT, "_typed_ast_27", NULL, 0, typed_ast_methods', 0)
        self.emit("};", 0)
        self.emit("PyMODINIT_FUNC", 0)
        self.emit("PyInit__typed_ast_27(void)", 0)
        self.emit("{", 0)
        self.emit("PyObject *m, *d;", 1)
        self.emit("if (!init_types()) return NULL;", 1)
        self.emit('m = PyModule_Create(&_typed_ast_27_module);', 1)
