...
file_rule(Parser *p)
{
    ...
    { // statements? $
        ...
        if (
            ...
            &&
            (endmarker_var = _Ta3Pegen_expect_token(p, ENDMARKER))  // token='ENDMARKER'
        )
        {
            res = _Ta3Pegen_make_module ( p , a );
...
type_expressions_rule(Parser *p)
{
    ...
    { // ','.expression+ ',' '*' expression ',' '**' expression
        ...
        if (
            ...
            &&
            (literal = _Ta3Pegen_expect_token(p, 12))  // token=','
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 16))  // token='*'
            &&
            (b = expression_rule(p))  // expression
            &&
            (literal_2 = _Ta3Pegen_expect_token(p, 12))  // token=','
            &&
            (literal_3 = _Ta3Pegen_expect_token(p, 35))  // token='**'
            &&
            (c = expression_rule(p))  // expression
        )
        {
            res = _Ta3Pegen_seq_append_to_end ( p , CHECK ( _Ta3Pegen_seq_append_to_end ( p , a , b ) ) , c );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // ','.expression+ ',' '*' expression
        ...
        {
            res = _Ta3Pegen_seq_append_to_end ( p , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // ','.expression+ ',' '**' expression
        ...
        if (
            ...
            (literal = _Ta3Pegen_expect_token(p, 12))  // token=','
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 35))  // token='**'
            &&
            (b = expression_rule(p))  // expression
        )
        {
    ...
    { // '*' expression ',' '**' expression
        ...
        Token * literal_2;
        if (
            (literal = _Ta3Pegen_expect_token(p, 16))  // token='*'
            &&
            (a = expression_rule(p))  // expression
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 12))  // token=','
            &&
            (literal_2 = _Ta3Pegen_expect_token(p, 35))  // token='**'
            &&
            (b = expression_rule(p))  // expression
        )
        {
            res = _Ta3Pegen_seq_append_to_end ( p , CHECK ( _Ta3Pegen_singleton_seq ( p , a ) ) , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '*' expression
        ...
        {
            res = _Ta3Pegen_singleton_seq ( p , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '**' expression
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 35))  // token='**'
            &&
            (a = expression_rule(p))  // expression
        )
        {
...
statement_newline_rule(Parser *p)
{
    ...
    asdl_seq* res = NULL;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
        return NULL;
    }
    ...
    { // compound_stmt NEWLINE
        ...
        if (
            (a = compound_stmt_rule(p))  // compound_stmt
            &&
            (newline_var = _Ta3Pegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        )
        {
            res = _Ta3Pegen_singleton_seq ( p , a );
            if (res == NULL && PyErr_Occurred()) {
    ...
    { // NEWLINE
        ...
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
                return NULL;
            }
            ...
            res = _Ta3Pegen_singleton_seq ( p , CHECK ( _Ta3_Pass ( EXTRA ) ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // $
        ...
        {
            res = _Ta3Pegen_interactive_exit ( p );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
simple_stmt_rule(Parser *p)
{
    ...
    { // small_stmt !';' NEWLINE
        ...
        if (
            ...
            &&
            _Ta3Pegen_lookahead_with_int(0, _Ta3Pegen_expect_token, p, 13)  // token=';'
            &&
            (newline_var = _Ta3Pegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        )
        {
    ...
    { // ';'.small_stmt+ ';'? NEWLINE
        ...
        if (
            ...
            &&
            (opt_var = _Ta3Pegen_expect_token(p, 13), 1)  // ';'?
            &&
            (newline_var = _Ta3Pegen_expect_token(p, NEWLINE))  // token='NEWLINE'
        )
        {
...
small_stmt_rule(Parser *p)
{
    ...
    stmt_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, small_stmt_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // &'return' return_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 500)  // token='return'
            &&
    ...
    { // &('import' | 'from') import_stmt
        ...
        if (
            _Ta3Pegen_lookahead(1, _tmp_14_rule, p)
            &&
    ...
    { // &'raise' raise_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 501)  // token='raise'
            &&
    ...
    { // 'pass'
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 502))  // token='pass'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
    ...
    { // &'del' del_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 503)  // token='del'
            &&
    ...
    { // &'yield' yield_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 504)  // token='yield'
            &&
    ...
    { // &'assert' assert_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 505)  // token='assert'
            &&
    ...
    { // 'break'
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 506))  // token='break'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
    ...
    { // 'continue'
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 507))  // token='continue'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
    ...
    { // &'global' global_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 508)  // token='global'
            &&
    ...
    { // &'nonlocal' nonlocal_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 509)  // token='nonlocal'
            &&
    ...
    _Ta3Pegen_insert_memo(p, mark, small_stmt_type, res);
    return res;
}
...
compound_stmt_rule(Parser *p)
{
    ...
    { // &('def' | '@' | ASYNC) function_def
        ...
        if (
            _Ta3Pegen_lookahead(1, _tmp_15_rule, p)
            &&
    ...
    { // &'if' if_stmt
        stmt_ty if_stmt_var;
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 510)  // token='if'
            &&
    ...
    { // &('class' | '@') class_def
        ...
        if (
            _Ta3Pegen_lookahead(1, _tmp_16_rule, p)
            &&
    ...
    { // &('with' | ASYNC) with_stmt
        ...
        if (
            _Ta3Pegen_lookahead(1, _tmp_17_rule, p)
            &&
    ...
    { // &('for' | ASYNC) for_stmt
        ...
        if (
            _Ta3Pegen_lookahead(1, _tmp_18_rule, p)
            &&
    ...
    { // &'try' try_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 511)  // token='try'
            &&
    ...
    { // &'while' while_stmt
        ...
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 512)  // token='while'
            &&
...
assignment_rule(Parser *p)
{
    ...
    { // NAME ':' expression ['=' annotated_rhs]
        ...
        Token * literal;
        if (
            (a = _Ta3Pegen_name_token(p))  // NAME
            &&
            (literal = _Ta3Pegen_expect_token(p, 11))  // token=':'
            &&
            (b = expression_rule(p))  // expression
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = CHECK_VERSION ( 6 , "Variable annotation syntax is" , _Ta3_AnnAssign ( CHECK ( _Ta3Pegen_set_expr_context ( p , a , Store ) ) , b , c , 1 , EXTRA ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // ('(' inside_paren_ann_assign_target ')' | ann_assign_subscript_attribute_target) ':' expression ['=' annotated_rhs]
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = CHECK_VERSION ( 6 , "Variable annotations syntax is" , _Ta3_AnnAssign ( a , b , c , 0 , EXTRA ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // ((star_targets '='))+ (yield_expr | star_expressions) TYPE_COMMENT?
        ...
        if (
            ...
            &&
            (tc = _Ta3Pegen_expect_token(p, TYPE_COMMENT), 1)  // TYPE_COMMENT?
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
    ...
    { // target augassign (yield_expr | star_expressions)
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_AugAssign ( a , b -> kind , c , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
augassign_rule(Parser *p)
{
    ...
    { // '+='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 36))  // token='+='
        )
        {
            res = _Ta3Pegen_augoperator ( p , Add );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '-='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 37))  // token='-='
        )
        {
            res = _Ta3Pegen_augoperator ( p , Sub );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '*='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 38))  // token='*='
        )
        {
            res = _Ta3Pegen_augoperator ( p , Mult );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '@='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 50))  // token='@='
        )
        {
            res = CHECK_VERSION ( 5 , "The '@' operator is" , _Ta3Pegen_augoperator ( p , MatMult ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '/='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 39))  // token='/='
        )
        {
            res = _Ta3Pegen_augoperator ( p , Div );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '%='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 40))  // token='%='
        )
        {
            res = _Ta3Pegen_augoperator ( p , Mod );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '&='
        ...
        {
            res = _Ta3Pegen_augoperator ( p , BitAnd );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '|='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 42))  // token='|='
        )
        {
            res = _Ta3Pegen_augoperator ( p , BitOr );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '^='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 43))  // token='^='
        )
        {
            res = _Ta3Pegen_augoperator ( p , BitXor );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '<<='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 44))  // token='<<='
        )
        {
            res = _Ta3Pegen_augoperator ( p , LShift );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '>>='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 45))  // token='>>='
        )
        {
            res = _Ta3Pegen_augoperator ( p , RShift );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '**='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 46))  // token='**='
        )
        {
            res = _Ta3Pegen_augoperator ( p , Pow );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '//='
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 48))  // token='//='
        )
        {
            res = _Ta3Pegen_augoperator ( p , FloorDiv );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
global_stmt_rule(Parser *p)
{
    ...
    { // 'global' ','.NAME+
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 508))  // token='global'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Global ( CHECK ( _Ta3Pegen_map_names_to_ids ( p , a ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
nonlocal_stmt_rule(Parser *p)
{
    ...
    { // 'nonlocal' ','.NAME+
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 509))  // token='nonlocal'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Nonlocal ( CHECK ( _Ta3Pegen_map_names_to_ids ( p , a ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
assert_stmt_rule(Parser *p)
{
    ...
    { // 'assert' expression [',' expression]
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 505))  // token='assert'
            &&
            (a = expression_rule(p))  // expression
            &&
...
del_stmt_rule(Parser *p)
{
    ...
    { // 'del' del_targets
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 503))  // token='del'
            &&
...
import_name_rule(Parser *p)
{
    ...
    { // 'import' dotted_as_names
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 513))  // token='import'
            &&
...
import_from_rule(Parser *p)
{
    ...
    { // 'from' (('.' | '...'))* dotted_name 'import' import_from_targets
        ...
        Token * keyword_1;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 514))  // token='from'
            &&
            (a = _loop0_30_rule(p))  // (('.' | '...'))*
            &&
            (b = dotted_name_rule(p))  // dotted_name
            &&
            (keyword_1 = _Ta3Pegen_expect_token(p, 513))  // token='import'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_ImportFrom ( b -> v . Name . id , c , _Ta3Pegen_seq_count_dots ( a ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // 'from' (('.' | '...'))+ 'import' import_from_targets
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_ImportFrom ( NULL , b , _Ta3Pegen_seq_count_dots ( a ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
import_from_targets_rule(Parser *p)
{
    ...
    { // '(' import_from_as_names ','? ')'
        ...
        if (
            ...
            &&
            (opt_var = _Ta3Pegen_expect_token(p, 12), 1)  // ','?
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 8))  // token=')'
        )
        {
    ...
    { // '*'
        ...
        {
            res = _Ta3Pegen_singleton_seq ( p , CHECK ( _Ta3Pegen_alias_for_star ( p ) ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
import_from_as_name_rule(Parser *p)
{
    ...
    { // NAME ['as' NAME]
        ...
        {
            res = _Ta3_alias ( a -> v . Name . id , ( b ) ? ( ( expr_ty ) b ) -> v . Name . id : NULL , p -> arena );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, dotted_name_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_0 = _Ta3Pegen_update_memo(p, mark, dotted_name_type, res);
        if (tmpvar_0) {
            return res;
        }
        p->mark = mark;
...
dotted_name_raw(Parser *p)
{
    ...
    { // dotted_name '.' NAME
        ...
        if (
            (a = dotted_name_rule(p))  // dotted_name
            &&
            (literal = _Ta3Pegen_expect_token(p, 23))  // token='.'
            &&
            (b = _Ta3Pegen_name_token(p))  // NAME
        )
        {
            res = _Ta3Pegen_join_names_with_dot ( p , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // NAME
        expr_ty name_var;
        if (
            (name_var = _Ta3Pegen_name_token(p))  // NAME
        )
        {
            res = name_var;
            goto done;
...
if_stmt_rule(Parser *p)
{
    ...
    { // 'if' named_expression ':' block elif_stmt
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 510))  // token='if'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_If ( a , b , CHECK ( _Ta3Pegen_singleton_seq ( p , c ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
elif_stmt_rule(Parser *p)
{
    ...
    { // 'elif' named_expression ':' block elif_stmt
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 515))  // token='elif'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (literal = _Ta3Pegen_expect_token(p, 11))  // token=':'
...
else_block_rule(Parser *p)
{
    ...
    { // 'else' ':' block
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 516))  // token='else'
            &&
            (literal = _Ta3Pegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
...
while_stmt_rule(Parser *p)
{
    ...
    { // 'while' named_expression ':' block else_block?
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 512))  // token='while'
            &&
            (a = named_expression_rule(p))  // named_expression
            &&
            (literal = _Ta3Pegen_expect_token(p, 11))  // token=':'
...
for_stmt_rule(Parser *p)
{
    ...
    { // 'for' star_targets 'in' star_expressions ':' TYPE_COMMENT? block else_block?
        ...
        void *tc;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 517))  // token='for'
            &&
            (t = star_targets_rule(p))  // star_targets
            &&
            (keyword_1 = _Ta3Pegen_expect_token(p, 518))  // token='in'
            &&
    ...
    { // ASYNC 'for' star_targets 'in' star_expressions ':' TYPE_COMMENT? block else_block?
        ...
        void *tc;
        if (
            (async_var = _Ta3Pegen_expect_token(p, ASYNC))  // token='ASYNC'
            &&
            (keyword = _Ta3Pegen_expect_token(p, 517))  // token='for'
            &&
            (t = star_targets_rule(p))  // star_targets
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = CHECK_VERSION ( 5 , "Async for loops are" , _Ta3_AsyncFor ( t , ex , b , el , NEW_TYPE_COMMENT ( p , tc ) , EXTRA ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
with_stmt_rule(Parser *p)
{
    ...
    { // 'with' '(' ','.with_item+ ','? ')' ':' block
        ...
        UNUSED(opt_var); // Silence compiler warnings
        if (
            (keyword = _Ta3Pegen_expect_token(p, 519))  // token='with'
            &&
            (literal = _Ta3Pegen_expect_token(p, 7))  // token='('
            &&
            ...
            (literal_1 = _Ta3Pegen_expect_token(p, 8))  // token=')'
            &&
            (literal_2 = _Ta3Pegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
        )
        {
    ...
    { // ASYNC 'with' '(' ','.with_item+ ','? ')' ':' block
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = CHECK_VERSION ( 5 , "Async with statements are" , _Ta3_AsyncWith ( a , b , NULL , EXTRA ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
try_stmt_rule(Parser *p)
{
    ...
    { // 'try' ':' block finally_block
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 511))  // token='try'
            &&
            (literal = _Ta3Pegen_expect_token(p, 11))  // token=':'
            &&
            (b = block_rule(p))  // block
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Try ( b , NULL , NULL , f , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
except_block_rule(Parser *p)
{
    ...
    { // 'except' expression ['as' target] ':' block
        ...
        void *t;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 520))  // token='except'
            &&
            (e = expression_rule(p))  // expression
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_ExceptHandler ( e , ( t ) ? ( ( expr_ty ) t ) -> v . Name . id : NULL , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // 'except' ':' block
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_ExceptHandler ( NULL , NULL , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
finally_block_rule(Parser *p)
{
    ...
    { // 'finally' ':' block
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 521))  // token='finally'
            &&
            (literal = _Ta3Pegen_expect_token(p, 11))  // token=':'
            &&
...
return_stmt_rule(Parser *p)
{
    ...
    { // 'return' star_expressions?
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 500))  // token='return'
            &&
...
raise_stmt_rule(Parser *p)
{
    ...
    { // 'raise' expression ['from' expression]
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 501))  // token='raise'
            &&
            (a = expression_rule(p))  // expression
            &&
    ...
    { // 'raise'
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Raise ( NULL , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
function_def_rule(Parser *p)
{
    ...
    { // decorators function_def_raw
        ...
        {
            res = _Ta3Pegen_function_def_decorators ( p , d , f );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
function_def_raw_rule(Parser *p)
{
    ...
    { // 'def' NAME '(' params? ')' ['->' expression] ':' func_type_comment? block
        ...
        void *tc;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 522))  // token='def'
            &&
            (n = _Ta3Pegen_name_token(p))  // NAME
            &&
            (literal = _Ta3Pegen_expect_token(p, 7))  // token='('
            &&
...
func_type_comment_rule(Parser *p)
{
    ...
    { // NEWLINE TYPE_COMMENT &(NEWLINE INDENT)
        ...
        if (
            ...
            &&
            _Ta3Pegen_lookahead(1, _tmp_52_rule, p)
        )
        {
            res = t;
            if (res == NULL && PyErr_Occurred()) {
...
parameters_rule(Parser *p)
{
    ...
    { // slash_no_default param_no_default* param_with_default* star_etc?
        ...
        {
            res = _Ta3Pegen_make_arguments ( p , a , NULL , b , c , d );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // slash_with_default param_with_default* star_etc?
        ...
        {
            res = _Ta3Pegen_make_arguments ( p , NULL , a , NULL , b , c );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // param_no_default+ param_with_default* star_etc?
        ...
        {
            res = _Ta3Pegen_make_arguments ( p , NULL , NULL , a , b , c );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // param_with_default+ star_etc?
        ...
        {
            res = _Ta3Pegen_make_arguments ( p , NULL , NULL , NULL , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // star_etc
        ...
        {
            res = _Ta3Pegen_make_arguments ( p , NULL , NULL , NULL , NULL , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
slash_no_default_rule(Parser *p)
{
    ...
    { // param_no_default+ '/' ','
        ...
        if (
            ...
            &&
            (literal = _Ta3Pegen_expect_token(p, 17))  // token='/'
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 12))  // token=','
        )
        {
...
slash_with_default_rule(Parser *p)
{
    ...
    { // param_no_default* param_with_default+ '/' ','
        ...
        {
            res = _Ta3Pegen_slash_with_default ( p , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
star_etc_rule(Parser *p)
{
    ...
    { // '*' param_no_default param_maybe_default* kwds?
        ...
        {
            res = _Ta3Pegen_star_etc ( p , a , b , c );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '*' ',' param_maybe_default+ kwds?
        ...
        {
            res = _Ta3Pegen_star_etc ( p , NULL , b , c );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // kwds
        ...
        {
            res = _Ta3Pegen_star_etc ( p , NULL , NULL , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
param_no_default_rule(Parser *p)
{
    ...
    { // param ',' TYPE_COMMENT?
        ...
        {
            res = _Ta3Pegen_add_type_comment_to_arg ( p , a , tc );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
param_with_default_rule(Parser *p)
{
    ...
    { // param default ',' TYPE_COMMENT?
        ...
        {
            res = _Ta3Pegen_name_default_pair ( p , a , c , tc );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
param_rule(Parser *p)
{
    ...
    { // NAME annotation?
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_arg ( a -> v . Name . id , b , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
default_rule(Parser *p)
{
    ...
    { // '=' expression
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 22))  // token='='
            &&
            (a = expression_rule(p))  // expression
        )
        {
...
class_def_rule(Parser *p)
{
    ...
    { // decorators class_def_raw
        ...
        {
            res = _Ta3Pegen_class_def_decorators ( p , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
class_def_raw_rule(Parser *p)
{
    ...
    { // 'class' NAME ['(' arguments? ')'] ':' block
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 523))  // token='class'
            &&
            (a = _Ta3Pegen_name_token(p))  // NAME
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_ClassDef ( a -> v . Name . id , ( b ) ? ( ( expr_ty ) b ) -> v . Call . args : NULL , ( b ) ? ( ( expr_ty ) b ) -> v . Call . keywords : NULL , c , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
block_rule(Parser *p)
{
    ...
    asdl_seq* res = NULL;
    if (_Ta3Pegen_is_memoized(p, block_type, &res))
        return res;
    int mark = p->mark;
    { // NEWLINE INDENT statements DEDENT
        ...
        if (
            (newline_var = _Ta3Pegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (indent_var = _Ta3Pegen_expect_token(p, INDENT))  // token='INDENT'
            &&
            (a = statements_rule(p))  // statements
            &&
            (dedent_var = _Ta3Pegen_expect_token(p, DEDENT))  // token='DEDENT'
        )
        {
            res = a;
            if (res == NULL && PyErr_Occurred()) {
    ...
    _Ta3Pegen_insert_memo(p, mark, block_type, res);
    return res;
}
...
star_expressions_rule(Parser *p)
{
    ...
    { // star_expression ((',' star_expression))+ ','?
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Tuple ( CHECK ( _Ta3Pegen_seq_insert_in_front ( p , a , b ) ) , Load , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // star_expression ','
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Tuple ( CHECK ( _Ta3Pegen_singleton_seq ( p , a ) ) , Load , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
star_expression_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, star_expression_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    _Ta3Pegen_insert_memo(p, mark, star_expression_type, res);
    return res;
}
...
named_expression_rule(Parser *p)
{
    ...
    { // NAME ':=' expression
        ...
        if (
            (a = _Ta3Pegen_name_token(p))  // NAME
            &&
            (literal = _Ta3Pegen_expect_token(p, 53))  // token=':='
            &&
            (b = expression_rule(p))  // expression
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_NamedExpr ( CHECK ( _Ta3Pegen_set_expr_context ( p , a , Store ) ) , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // expression !':='
        ...
        if (
            (expression_var = expression_rule(p))  // expression
            &&
            _Ta3Pegen_lookahead_with_int(0, _Ta3Pegen_expect_token, p, 53)  // token=':='
        )
        {
            res = expression_var;
            goto done;
...
expression_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, expression_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // disjunction 'if' disjunction 'else' expression
        ...
        if (
            ...
            &&
            (keyword_1 = _Ta3Pegen_expect_token(p, 516))  // token='else'
            &&
            (c = expression_rule(p))  // expression
        )
        {
    ...
    _Ta3Pegen_insert_memo(p, mark, expression_type, res);
    return res;
}
...
lambdef_rule(Parser *p)
{
    ...
    { // 'lambda' lambda_parameters? ':' expression
        ...
        Token * literal;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 524))  // token='lambda'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Lambda ( ( a ) ? a : CHECK ( _Ta3Pegen_empty_arguments ( p ) ) , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
lambda_slash_no_default_rule(Parser *p)
{
    ...
    { // lambda_param_no_default+ '/' &':'
        ...
        if (
            ...
            (literal = _Ta3Pegen_expect_token(p, 17))  // token='/'
            &&
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 11)  // token=':'
        )
        {
            res = a;
            if (res == NULL && PyErr_Occurred()) {
...
lambda_param_with_default_rule(Parser *p)
{
    ...
    { // lambda_param default ','
        ...
        {
            res = _Ta3Pegen_name_default_pair ( p , a , c , NULL );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
lambda_param_rule(Parser *p)
{
    ...
    { // NAME
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_arg ( a -> v . Name . id , NULL , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
disjunction_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, disjunction_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // conjunction (('or' conjunction))+
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BoolOp ( Or , CHECK ( _Ta3Pegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, disjunction_type, res);
    return res;
}
...
conjunction_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, conjunction_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // inversion (('and' inversion))+
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BoolOp ( And , CHECK ( _Ta3Pegen_seq_insert_in_front ( p , a , b ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, conjunction_type, res);
    return res;
}
...
inversion_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, inversion_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // 'not' inversion
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 525))  // token='not'
            &&
            (a = inversion_rule(p))  // inversion
        )
        {
    ...
    _Ta3Pegen_insert_memo(p, mark, inversion_type, res);
    return res;
}
...
comparison_rule(Parser *p)
{
    ...
    { // bitwise_or compare_op_bitwise_or_pair+
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Compare ( a , CHECK ( _Ta3Pegen_get_cmpops ( p , b ) ) , CHECK ( _Ta3Pegen_get_exprs ( p , b ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
eq_bitwise_or_rule(Parser *p)
{
    ...
    { // '==' bitwise_or
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 27))  // token='=='
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , Eq , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
noteq_bitwise_or_rule(Parser *p)
{
    ...
    { // ('!=') bitwise_or
        ...
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , NotEq , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
lte_bitwise_or_rule(Parser *p)
{
    ...
    { // '<=' bitwise_or
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 29))  // token='<='
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , LtE , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
lt_bitwise_or_rule(Parser *p)
{
    ...
    { // '<' bitwise_or
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 20))  // token='<'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , Lt , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
gte_bitwise_or_rule(Parser *p)
{
    ...
    { // '>=' bitwise_or
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 30))  // token='>='
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , GtE , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
gt_bitwise_or_rule(Parser *p)
{
    ...
    { // '>' bitwise_or
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 21))  // token='>'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , Gt , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
notin_bitwise_or_rule(Parser *p)
{
    ...
    { // 'not' 'in' bitwise_or
        ...
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , NotIn , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
in_bitwise_or_rule(Parser *p)
{
    ...
    { // 'in' bitwise_or
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 518))  // token='in'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , In , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
isnot_bitwise_or_rule(Parser *p)
{
    ...
    { // 'is' 'not' bitwise_or
        ...
        Token * keyword_1;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 526))  // token='is'
            &&
            (keyword_1 = _Ta3Pegen_expect_token(p, 525))  // token='not'
            &&
            (a = bitwise_or_rule(p))  // bitwise_or
        )
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , IsNot , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
is_bitwise_or_rule(Parser *p)
{
    ...
    { // 'is' bitwise_or
        ...
        {
            res = _Ta3Pegen_cmpop_expr_pair ( p , Is , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, bitwise_or_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_1 = _Ta3Pegen_update_memo(p, mark, bitwise_or_type, res);
        if (tmpvar_1) {
            return res;
        }
        p->mark = mark;
...
bitwise_or_raw(Parser *p)
{
    ...
    { // bitwise_or '|' bitwise_xor
        ...
        if (
            (a = bitwise_or_rule(p))  // bitwise_or
            &&
            (literal = _Ta3Pegen_expect_token(p, 18))  // token='|'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BinOp ( a , BitOr , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, bitwise_xor_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_2 = _Ta3Pegen_update_memo(p, mark, bitwise_xor_type, res);
        if (tmpvar_2) {
            return res;
        }
        p->mark = mark;
...
bitwise_xor_raw(Parser *p)
{
    ...
    { // bitwise_xor '^' bitwise_and
        ...
        if (
            ...
            &&
            (literal = _Ta3Pegen_expect_token(p, 32))  // token='^'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BinOp ( a , BitXor , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, bitwise_and_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_3 = _Ta3Pegen_update_memo(p, mark, bitwise_and_type, res);
        if (tmpvar_3) {
            return res;
        }
        p->mark = mark;
...
bitwise_and_raw(Parser *p)
{
    ...
    { // bitwise_and '&' shift_expr
        ...
        if (
            ...
            &&
            (literal = _Ta3Pegen_expect_token(p, 19))  // token='&'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BinOp ( a , BitAnd , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, shift_expr_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_4 = _Ta3Pegen_update_memo(p, mark, shift_expr_type, res);
        if (tmpvar_4) {
            return res;
        }
        p->mark = mark;
...
shift_expr_raw(Parser *p)
{
    ...
    { // shift_expr '<<' sum
        ...
        if (
            ...
            &&
            (literal = _Ta3Pegen_expect_token(p, 33))  // token='<<'
            &&
            (b = sum_rule(p))  // sum
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BinOp ( a , LShift , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // shift_expr '>>' sum
        ...
        if (
            (a = shift_expr_rule(p))  // shift_expr
            &&
            (literal = _Ta3Pegen_expect_token(p, 34))  // token='>>'
            &&
            (b = sum_rule(p))  // sum
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BinOp ( a , RShift , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, sum_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_5 = _Ta3Pegen_update_memo(p, mark, sum_type, res);
        if (tmpvar_5) {
            return res;
        }
        p->mark = mark;
...
sum_raw(Parser *p)
{
    ...
    { // sum '+' term
        ...
        if (
            (a = sum_rule(p))  // sum
            &&
            (literal = _Ta3Pegen_expect_token(p, 14))  // token='+'
            &&
            (b = term_rule(p))  // term
        )
        {
    ...
    { // sum '-' term
        ...
        if (
            (a = sum_rule(p))  // sum
            &&
            (literal = _Ta3Pegen_expect_token(p, 15))  // token='-'
            &&
            (b = term_rule(p))  // term
        )
        {
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, term_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_6 = _Ta3Pegen_update_memo(p, mark, term_type, res);
        if (tmpvar_6) {
            return res;
        }
        p->mark = mark;
...
term_raw(Parser *p)
{
    ...
    { // term '//' factor
        ...
        if (
            (a = term_rule(p))  // term
            &&
            (literal = _Ta3Pegen_expect_token(p, 47))  // token='//'
            &&
            (b = factor_rule(p))  // factor
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_BinOp ( a , FloorDiv , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // term '%' factor
        ...
        if (
            (a = term_rule(p))  // term
            &&
            (literal = _Ta3Pegen_expect_token(p, 24))  // token='%'
            &&
            (b = factor_rule(p))  // factor
        )
        {
    ...
    { // term '@' factor
        ...
        if (
            (a = term_rule(p))  // term
            &&
            (literal = _Ta3Pegen_expect_token(p, 49))  // token='@'
            &&
            (b = factor_rule(p))  // factor
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = CHECK_VERSION ( 5 , "The '@' operator is" , _Ta3_BinOp ( a , MatMult , b , EXTRA ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
factor_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, factor_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // '~' factor
        ...
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 31))  // token='~'
            &&
            (a = factor_rule(p))  // factor
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_UnaryOp ( Invert , a , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, factor_type, res);
    return res;
}
...
await_primary_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, await_primary_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // AWAIT primary
        ...
        Token * await_var;
        if (
            (await_var = _Ta3Pegen_expect_token(p, AWAIT))  // token='AWAIT'
            &&
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = CHECK_VERSION ( 5 , "Await expressions are" , _Ta3_Await ( a , EXTRA ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, await_primary_type, res);
    return res;
}
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, primary_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_7 = _Ta3Pegen_update_memo(p, mark, primary_type, res);
        if (tmpvar_7) {
            return res;
        }
        p->mark = mark;
...
primary_raw(Parser *p)
{
    ...
    { // primary '.' NAME
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Attribute ( a , b -> v . Name . id , Load , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // primary genexp
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Call ( a , CHECK ( _Ta3Pegen_singleton_seq ( p , b ) ) , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // primary '(' arguments? ')'
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Call ( a , ( b ) ? ( ( expr_ty ) b ) -> v . Call . args : NULL , ( b ) ? ( ( expr_ty ) b ) -> v . Call . keywords : NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // primary '[' slices ']'
        ...
        if (
            (a = primary_rule(p))  // primary
            &&
            (literal = _Ta3Pegen_expect_token(p, 9))  // token='['
            &&
            (b = slices_rule(p))  // slices
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 10))  // token=']'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Subscript ( a , b , Load , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
slices_rule(Parser *p)
{
    ...
    { // slice !','
        ...
        if (
            ...
            &&
            _Ta3Pegen_lookahead_with_int(0, _Ta3Pegen_expect_token, p, 12)  // token=','
        )
        {
            res = a;
            if (res == NULL && PyErr_Occurred()) {
...
atom_rule(Parser *p)
{
    ...
    { // 'True'
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 527))  // token='True'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Constant ( Py_True , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // 'False'
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Constant ( Py_False , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // 'None'
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 529))  // token='None'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Constant ( Py_None , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // '__new_parser__'
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 530))  // token='__new_parser__'
        )
        {
    ...
    { // &STRING strings
        expr_ty strings_var;
        if (
            _Ta3Pegen_lookahead(1, _Ta3Pegen_string_token, p)
            &&
    ...
    { // NUMBER
        expr_ty number_var;
        if (
            (number_var = _Ta3Pegen_number_token(p))  // NUMBER
        )
        {
            res = number_var;
            goto done;
    ...
    { // &'(' (tuple | group | genexp)
        void *_tmp_96_var;
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 7)  // token='('
            &&
    ...
    { // &'[' (list | listcomp)
        void *_tmp_97_var;
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 9)  // token='['
            &&
    ...
    { // &'{' (dict | set | dictcomp | setcomp)
        void *_tmp_98_var;
        if (
            _Ta3Pegen_lookahead_with_int(1, _Ta3Pegen_expect_token, p, 25)  // token='{'
            &&
    ...
    { // '...'
        Token * literal;
        if (
            (literal = _Ta3Pegen_expect_token(p, 52))  // token='...'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Constant ( Py_Ellipsis , NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
strings_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, strings_type, &res))
        return res;
    int mark = p->mark;
    { // STRING+
        asdl_seq * a;
        ...
        {
            res = _Ta3Pegen_concatenate_strings ( p , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, strings_type, res);
    return res;
}
...
genexp_rule(Parser *p)
{
    ...
    { // '(' expression for_if_clauses ')'
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_GeneratorExp ( a , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
set_rule(Parser *p)
{
    ...
    { // '{' expressions_list '}'
        ...
        Token * literal_1;
        if (
            (literal = _Ta3Pegen_expect_token(p, 25))  // token='{'
            &&
            (a = expressions_list_rule(p))  // expressions_list
            &&
            (literal_1 = _Ta3Pegen_expect_token(p, 26))  // token='}'
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
...
dict_rule(Parser *p)
{
    ...
    { // '{' kvpairs? '}'
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Dict ( CHECK ( _Ta3Pegen_get_keys ( p , a ) ) , CHECK ( _Ta3Pegen_get_values ( p , a ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
dictcomp_rule(Parser *p)
{
    ...
    { // '{' kvpair for_if_clauses '}'
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_DictComp ( a -> key , a -> value , b , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
kvpair_rule(Parser *p)
{
    ...
    { // '**' bitwise_or
        ...
        {
            res = _Ta3Pegen_key_value_pair ( p , NULL , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // expression ':' expression
        ...
        {
            res = _Ta3Pegen_key_value_pair ( p , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
for_if_clause_rule(Parser *p)
{
    ...
    { // ASYNC 'for' star_targets 'in' disjunction (('if' disjunction))*
        ...
        {
            res = CHECK_VERSION ( 6 , "Async comprehensions are" , _Ta3_comprehension ( a , b , c , 1 , p -> arena ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // 'for' star_targets 'in' disjunction (('if' disjunction))*
        ...
        {
            res = _Ta3_comprehension ( a , b , c , 0 , p -> arena );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
yield_expr_rule(Parser *p)
{
    ...
    { // 'yield' 'from' expression
        ...
        Token * keyword_1;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 504))  // token='yield'
            &&
            (keyword_1 = _Ta3Pegen_expect_token(p, 514))  // token='from'
            &&
            (a = expression_rule(p))  // expression
        )
        {
...
arguments_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, arguments_type, &res))
        return res;
    int mark = p->mark;
    { // args ','? &')'
        expr_ty a;
    ...
    _Ta3Pegen_insert_memo(p, mark, arguments_type, res);
    return res;
}
...
args_rule(Parser *p)
{
    ...
    { // starred_expression [',' args]
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Call ( _Ta3Pegen_dummy_name ( p ) , ( b ) ? CHECK ( _Ta3Pegen_seq_insert_in_front ( p , a , ( ( expr_ty ) b ) -> v . Call . args ) ) : CHECK ( _Ta3Pegen_singleton_seq ( p , a ) ) , ( b ) ? ( ( expr_ty ) b ) -> v . Call . keywords : NULL , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // kwargs
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Call ( _Ta3Pegen_dummy_name ( p ) , CHECK_NULL_ALLOWED ( _Ta3Pegen_seq_extract_starred_exprs ( p , a ) ) , CHECK_NULL_ALLOWED ( _Ta3Pegen_seq_delete_starred_exprs ( p , a ) ) , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
kwargs_rule(Parser *p)
{
    ...
    { // ','.kwarg_or_starred+ ',' ','.kwarg_or_double_starred+
        ...
        {
            res = _Ta3Pegen_join_sequences ( p , a , b );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
kwarg_or_starred_rule(Parser *p)
{
    ...
    { // NAME '=' expression
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3Pegen_keyword_or_starred ( p , CHECK ( _Ta3_keyword ( a -> v . Name . id , b , EXTRA ) ) , 1 );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // starred_expression
        ...
        {
            res = _Ta3Pegen_keyword_or_starred ( p , a , 0 );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
kwarg_or_double_starred_rule(Parser *p)
{
    ...
    { // '**' expression
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3Pegen_keyword_or_starred ( p , CHECK ( _Ta3_keyword ( NULL , a , EXTRA ) ) , 1 );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
star_targets_rule(Parser *p)
{
    ...
    { // star_target ((',' star_target))* ','?
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Tuple ( CHECK ( _Ta3Pegen_seq_insert_in_front ( p , a , b ) ) , Store , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
star_target_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, star_target_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // '*' (!'*' star_target)
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Starred ( CHECK ( _Ta3Pegen_set_expr_context ( p , a , Store ) ) , Store , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // t_primary '.' NAME !t_lookahead
        ...
        if (
            ...
            (b = _Ta3Pegen_name_token(p))  // NAME
            &&
            _Ta3Pegen_lookahead(0, t_lookahead_rule, p)
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Attribute ( a , b -> v . Name . id , Store , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // t_primary '[' slices ']' !t_lookahead
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Subscript ( a , b , Store , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, star_target_type, res);
    return res;
}
...
star_atom_rule(Parser *p)
{
    ...
    { // NAME
        ...
        {
            res = _Ta3Pegen_set_expr_context ( p , a , Store );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
del_target_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, del_target_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    { // t_primary '.' NAME !t_lookahead
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Attribute ( a , b -> v . Name . id , Del , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    { // t_primary '[' slices ']' !t_lookahead
        ...
        )
        {
            ...
            int end_col_offset = token->end_col_offset;
            UNUSED(end_col_offset); // Only used by EXTRA macro
            res = _Ta3_Subscript ( a , b , Del , EXTRA );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
    ...
    _Ta3Pegen_insert_memo(p, mark, del_target_type, res);
    return res;
}
...
del_t_atom_rule(Parser *p)
{
    ...
    { // NAME
        ...
        {
            res = _Ta3Pegen_set_expr_context ( p , a , Del );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
target_rule(Parser *p)
{
    ...
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, target_type, &res))
        return res;
    int mark = p->mark;
    if (p->mark == p->fill && _Ta3Pegen_fill_token(p) < 0) {
        p->error_indicator = 1;
    ...
    _Ta3Pegen_insert_memo(p, mark, target_type, res);
    return res;
}
...
{
    expr_ty res = NULL;
    if (_Ta3Pegen_is_memoized(p, t_primary_type, &res))
        return res;
    int mark = p->mark;
    int resmark = p->mark;
    while (1) {
        int tmpvar_8 = _Ta3Pegen_update_memo(p, mark, t_primary_type, res);
        if (tmpvar_8) {
            return res;
        }
        p->mark = mark;
...
t_primary_raw(Parser *p)
{
    ...
    { // t_primary '.' NAME &t_lookahead
        ...
        if (
            ...
            (b = _Ta3Pegen_name_token(p))  // NAME
            &&
            _Ta3Pegen_lookahead(1, t_lookahead_rule, p)
        )
        {
            Token *token = _Ta3Pegen_get_last_nonnwhitespace_token(p);
            if (token == NULL) {
...
incorrect_arguments_rule(Parser *p)
{
    ...
    { // args ',' args
        ...
        {
            res = _Ta3Pegen_arguments_parsing_error ( p , a );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
invalid_named_expression_rule(Parser *p)
{
    ...
    { // expression ':=' expression
        ...
        {
            res = RAISE_SYNTAX_ERROR ( "cannot use assignment expressions with %s" , _Ta3Pegen_get_expr_name ( a ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
invalid_assignment_rule(Parser *p)
{
    ...
    { // expression ('=' | augassign) (yield_expr | star_expressions)
        ...
        {
            res = RAISE_SYNTAX_ERROR_NO_COL_OFFSET ( "cannot assign to %s" , _Ta3Pegen_get_expr_name ( a ) );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
invalid_block_rule(Parser *p)
{
    ...
    { // NEWLINE !INDENT
        ...
        if (
            (newline_var = _Ta3Pegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            _Ta3Pegen_lookahead_with_int(0, _Ta3Pegen_expect_token, p, INDENT)  // token=INDENT
        )
        {
...
invalid_double_type_comments_rule(Parser *p)
{
    ...
    { // TYPE_COMMENT NEWLINE TYPE_COMMENT NEWLINE INDENT
        ...
        if (
            ...
            &&
            (newline_var_1 = _Ta3Pegen_expect_token(p, NEWLINE))  // token='NEWLINE'
            &&
            (indent_var = _Ta3Pegen_expect_token(p, INDENT))  // token='INDENT'
        )
        {
...
_loop0_1_rule(Parser *p)
{
    ...
    asdl_seq *seq = _Ta3_asdl_seq_new(n, p->arena);
    if (!seq) {
    ...
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_1_type, seq);
    return seq;
}
...
_loop0_2_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_2_type, seq);
    return seq;
}
...
_loop0_4_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_4_type, seq);
    return seq;
}
...
_gather_3_rule(Parser *p)
{
    ...
    { // expression _loop0_4
        ...
        {
            res = _Ta3Pegen_seq_insert_in_front(p, elem, seq);
            goto done;
        }
        p->mark = mark;
    }
...
_loop0_6_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_6_type, seq);
    return seq;
}
...
_loop0_8_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_8_type, seq);
    return seq;
}
...
_loop0_10_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_10_type, seq);
    return seq;
}
...
_loop1_11_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_11_type, seq);
    return seq;
}
...
_loop0_13_rule(Parser *p)
{
    ...
    { // ';' small_stmt
        ...
        Token * literal;
        while (
            (literal = _Ta3Pegen_expect_token(p, 13))  // token=';'
            &&
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_13_type, seq);
    return seq;
}
...
_loop1_22_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_22_type, seq);
    return seq;
}
...
_loop0_26_rule(Parser *p)
{
    ...
    { // ',' NAME
        ...
        while (
            (literal = _Ta3Pegen_expect_token(p, 12))  // token=','
            &&
            (elem = _Ta3Pegen_name_token(p))  // NAME
        )
        {
            res = elem;
            if (res == NULL && PyErr_Occurred()) {
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_26_type, seq);
    return seq;
}
...
_loop0_28_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_28_type, seq);
    return seq;
}
...
_loop0_30_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_30_type, seq);
    return seq;
}
...
_loop1_31_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_31_type, seq);
    return seq;
}
...
_loop0_33_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_33_type, seq);
    return seq;
}
...
_tmp_34_rule(Parser *p)
{
    ...
    { // 'as' NAME
        ...
        expr_ty z;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 531))  // token='as'
            &&
            (z = _Ta3Pegen_name_token(p))  // NAME
        )
        {
            res = z;
            if (res == NULL && PyErr_Occurred()) {
...
_loop0_36_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_36_type, seq);
    return seq;
}
...
_loop0_39_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_39_type, seq);
    return seq;
}
...
_loop0_41_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_41_type, seq);
    return seq;
}
...
_loop0_43_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_43_type, seq);
    return seq;
}
...
_loop0_45_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_45_type, seq);
    return seq;
}
...
_loop1_47_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_47_type, seq);
    return seq;
}
...
_tmp_50_rule(Parser *p)
{
    ...
    { // '->' expression
        ...
        expr_ty z;
        if (
            (literal = _Ta3Pegen_expect_token(p, 51))  // token='->'
            &&
            (z = expression_rule(p))  // expression
        )
        {
...
_tmp_52_rule(Parser *p)
{
    ...
    { // NEWLINE INDENT
        ...
        {
            res = _Ta3Pegen_dummy_name(p, newline_var, indent_var);
            goto done;
        }
        p->mark = mark;
    }
...
_loop0_53_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_53_type, seq);
    return seq;
}
...
_loop0_54_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_54_type, seq);
    return seq;
}
...
_loop0_55_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_55_type, seq);
    return seq;
}
...
_loop1_56_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_56_type, seq);
    return seq;
}
...
_loop0_57_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_57_type, seq);
    return seq;
}
...
_loop1_58_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_58_type, seq);
    return seq;
}
...
_loop1_59_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_59_type, seq);
    return seq;
}
...
_loop1_60_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_60_type, seq);
    return seq;
}
...
_loop0_61_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_61_type, seq);
    return seq;
}
...
_loop1_62_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_62_type, seq);
    return seq;
}
...
_loop0_63_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_63_type, seq);
    return seq;
}
...
_loop1_64_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_64_type, seq);
    return seq;
}
...
_loop0_65_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_65_type, seq);
    return seq;
}
...
_loop1_66_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_66_type, seq);
    return seq;
}
...
_loop1_67_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_67_type, seq);
    return seq;
}
...
_loop0_70_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_70_type, seq);
    return seq;
}
...
_loop1_71_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_71_type, seq);
    return seq;
}
...
_loop0_73_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_73_type, seq);
    return seq;
}
...
_loop1_74_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_74_type, seq);
    return seq;
}
...
_loop0_75_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_75_type, seq);
    return seq;
}
...
_loop0_76_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_76_type, seq);
    return seq;
}
...
_loop0_77_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_77_type, seq);
    return seq;
}
...
_loop1_78_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_78_type, seq);
    return seq;
}
...
_loop0_79_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_79_type, seq);
    return seq;
}
...
_loop1_80_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_80_type, seq);
    return seq;
}
...
_loop1_81_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_81_type, seq);
    return seq;
}
...
_loop1_82_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_82_type, seq);
    return seq;
}
...
_loop0_83_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_83_type, seq);
    return seq;
}
...
_loop1_84_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_84_type, seq);
    return seq;
}
...
_loop0_85_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_85_type, seq);
    return seq;
}
...
_loop1_86_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_86_type, seq);
    return seq;
}
...
_loop0_87_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_87_type, seq);
    return seq;
}
...
_loop1_88_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_88_type, seq);
    return seq;
}
...
_loop1_89_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_89_type, seq);
    return seq;
}
...
_loop1_90_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_90_type, seq);
    return seq;
}
...
_loop1_91_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_91_type, seq);
    return seq;
}
...
_tmp_92_rule(Parser *p)
{
    ...
    { // '!='
        Token * tok;
        if (
            (tok = _Ta3Pegen_expect_token(p, 28))  // token='!='
        )
        {
            res = _Ta3Pegen_check_barry_as_flufl ( p ) ? NULL : tok;
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
_loop0_94_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_94_type, seq);
    return seq;
}
...
_loop1_99_rule(Parser *p)
{
    ...
    { // STRING
        expr_ty string_var;
        while (
            (string_var = _Ta3Pegen_string_token(p))  // STRING
        )
        {
            res = string_var;
            if (n == children_capacity) {
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_99_type, seq);
    return seq;
}
...
_tmp_100_rule(Parser *p)
{
    ...
    { // star_named_expression ',' star_named_expressions?
        ...
        {
            res = _Ta3Pegen_seq_insert_in_front ( p , y , z );
            if (res == NULL && PyErr_Occurred()) {
                p->error_indicator = 1;
                return NULL;
            }
...
_loop0_103_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_103_type, seq);
    return seq;
}
...
_loop1_104_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_104_type, seq);
    return seq;
}
...
_loop0_105_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_105_type, seq);
    return seq;
}
...
_loop0_106_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_106_type, seq);
    return seq;
}
...
_loop0_110_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_110_type, seq);
    return seq;
}
...
_loop0_112_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_112_type, seq);
    return seq;
}
...
_loop0_114_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_114_type, seq);
    return seq;
}
...
_loop0_116_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_116_type, seq);
    return seq;
}
...
_loop0_117_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_117_type, seq);
    return seq;
}
...
_loop0_119_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_119_type, seq);
    return seq;
}
...
_tmp_120_rule(Parser *p)
{
    ...
    { // !'*' star_target
        ...
        if (
            _Ta3Pegen_lookahead_with_int(0, _Ta3Pegen_expect_token, p, 16)  // token='*'
            &&
...
_loop0_122_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_122_type, seq);
    return seq;
}
...
_loop0_124_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_124_type, seq);
    return seq;
}
...
_tmp_125_rule(Parser *p)
{
    ...
    { // expression for_if_clauses
        ...
        {
            res = _Ta3Pegen_dummy_name(p, expression_var, for_if_clauses_var);
            goto done;
        }
        p->mark = mark;
    }
...
_tmp_126_rule(Parser *p)
{
    ...
    { // '=' annotated_rhs
        ...
        {
            res = _Ta3Pegen_dummy_name(p, literal, annotated_rhs_var);
            goto done;
        }
        p->mark = mark;
    }
...
_loop0_130_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop0_130_type, seq);
    return seq;
}
...
_tmp_132_rule(Parser *p)
{
    ...
    { // ',' (')' | '**')
        ...
        {
            res = _Ta3Pegen_dummy_name(p, literal, _tmp_146_var);
            goto done;
        }
        p->mark = mark;
    }
...
_tmp_133_rule(Parser *p)
{
    ...
    { // ',' (':' | '**')
        ...
        {
            res = _Ta3Pegen_dummy_name(p, literal, _tmp_147_var);
            goto done;
        }
        p->mark = mark;
    }
...
_tmp_140_rule(Parser *p)
{
    ...
    { // 'or' conjunction
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 532))  // token='or'
            &&
...
_tmp_141_rule(Parser *p)
{
    ...
    { // 'and' inversion
        ...
        Token * keyword;
        if (
            (keyword = _Ta3Pegen_expect_token(p, 533))  // token='and'
            &&
...
_loop1_145_rule(Parser *p)
{
    ...
    for (int i = 0; i < n; i++) asdl_seq_SET(seq, i, children[i]);
    PyMem_Free(children);
    _Ta3Pegen_insert_memo(p, start_mark, _loop1_145_type, seq);
    return seq;
}
