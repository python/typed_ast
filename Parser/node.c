 ...
 * a number >= the input.  In TaNode_AddChild, it's used like so, when
 ...
 * TaNode_AddChild passed 1 for the size, and 9% passed 4.  So this usually
...
int
TaNode_AddChild(node *n1, int type, char *str, int lineno, int col_offset)
{
